package com.xworkz.jdbc.webseries.dto;
...
public class WebSeriesDTO {
	...
	private StreamedIn w_streamedIn;
	private Genre w_gener;
	...
	public WebSeriesDTO(String w_name, int w_id, int w_noOfEpisodes, StreamedIn w_streamedIn, Genre w_gener,
	...
	public WebSeriesDTO(String w_name, int w_noOfEpisodes, StreamedIn w_streamedIn, Genre w_gener,
			int w_yestAgeIndaNodbohudu) {
		super();
		this.w_name = w_name;
		this.w_noOfEpisodes = w_noOfEpisodes;
	...
	public StreamedIn getW_streamedIn() {
		return w_streamedIn;
	}

	public void setW_streamedIn(StreamedIn w_streamedIn) {
		this.w_streamedIn = w_streamedIn;
	}

	public Genre getW_gener() {
		return w_gener;
	}

	public void setW_gener(Genre w_gener) {
		this.w_gener = w_gener;
	}
